                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      @if($getRecord->image)
                        <img width="100" height="100" src="{{ url('public/images/download/'.$getRecord->image) }}">
                      @endif
                    </div>  
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="image_url" class="form-control" placeholder="Enter Image Url" required value="{{ $getRecord->image_url }}">
